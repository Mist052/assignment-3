...
public class Fox extends Animal
{
     ...
     * rabbits and sleeps. In the process, it might breed,get infected,
     * die of hunger, die of old age, or die due to hypothermia.
     * 
    ...
    public void act(Field currentField, Field nextFieldState)
    {
        ...
        // If the fox is infected it remains in current location.
        if(isInfected()) {
            incrementAge();
            incrementHunger();
            if(isAlive()) {
        ...
        // If it's sleep time, the fox does not move.
        ...
        while(foodLocation == null && it.hasNext()) {
            ...
            if(animal instanceof Rabbit rabbit) {
                if(rabbit.isAlive()) {
                    ...
                    // If the rabbit was infected, transmit the disease to the fox.
